...
import lifeja from "../content/life/ja.json";
import lifeen from "../content/life/en.json";
...
export const copy = {
  ja: { ...homeja, ...researchja, ...peopleja, ...publicationsja, ...studentsja, ...lifeja, ...commonja },
  en: { ...homeen, ...researchen, ...peopleen, ...publicationsen, ...studentsen, ...lifeen, ...commonen },
};
